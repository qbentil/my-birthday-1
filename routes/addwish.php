<div class="modal">
        <div class="modal-content">
            ...
            <form id="wish-book" method="POST" autocomplete="off">
              ...
              <textarea id="message" class="form-group" name="message" placeholder="Write something for Bentil💻🥰 [Max: 225 Letters]" style="height:160px" maxlength="225"></textarea>
